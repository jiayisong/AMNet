...
from .my_modulated_deform_conv import modulated_deform_conv2d, ModulatedDeformConv2d
...
__all__ = [
    ...
    'PAConvCUDASAModuleMSG', 'RoIPointPool3d', 'modulated_deform_conv2d', 'ModulatedDeformConv2d'
]
