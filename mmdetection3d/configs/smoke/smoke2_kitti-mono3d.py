...
work_dir = '/mnt/jys/mmdetection3d/work_dirs/smoke_126/'
# resume_from2 = '/mnt/jys/mmdetection3d/work_dirs/smoke_98/latest.pth'
resume_from2 = None
gpu_ids = [0]
BATCH_SIZE = 8
...
train_pipeline = [
    ...
    dict(type='K_out'),
    # dict(type='CylinderAndImgToTensor', size=IMG_SIZE,
    #      intrinsics=((881.8, 0.0, 639.5), (0.0, 966.86, 172.854), (0.0, 0.0, 1.0)), random_shift=(32, 0),
    #      random_scale=(1, 1)),
    dict(type='UnifiedIntrinsics', size=TRAIN_IMG_SIZE,
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Normalize', **img_norm_cfg),
            # dict(type='CylinderAndImgToTensor', size=IMG_SIZE,
            #      intrinsics=((881.8, 0.0, 639.5), (0.0, 966.86, 172.854), (0.0, 0.0, 1.0))),
            dict(type='UnifiedIntrinsics', size=TEST_IMG_SIZE,
...
model = dict(backbone=dict(in_channels=4, init_cfg=dict(type='Pretrained',
