...
work_dir = '/mnt/jys/mmdetection3d/work_dirs/threestage_dla34_kittimono3d_AdamW_baseline_复现/'
# resume_from2 = '/mnt/jys/mmdetection3d/work_dirs/threestage_dla34_kittimono3d_257/latest.pth'
resume_from2 = None
gpu_ids = [5]
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Normalize', **img_norm_cfg),
            dict(type='Init'),
            dict(type='UnifiedIntrinsics', size=IMG_SIZE, random_shift=0),
            dict(type='Pad', size=IMG_SIZE),
            dict(type='Img2Cam'),
            # dict(type='Bbox8dtoXyzxyz'),
