...
work_dir = '/usr/jys/mmdetection3d/work_dirs/threestage_dla34_nusmono3d_depthtrain/'
# resume_from2 = '/usr/jys/mmdetection3d/work_dirs/threestage_dla34_nusmono3d_1/latest.pth'
resume_from2 = None
gpu_ids = [2]
