...
work_dir = '/mnt/jys/mmdetection3d/work_dirs/threestage_dla34_kittimono3d_SGD_5e5/'
...
optimizer_config = dict(_delete_=True,
                        ...
                        grad_clip=dict(
                            type='my_clip_grads',
                            max_norm=2000, norm_type=2))
# optimizer_config = dict(grad_clip=None)
optimizer = dict(_delete_=True,
                 type='SGD', lr=5e-5, momentum=0.9, weight_decay=5e-4,  # nesterov=True,
