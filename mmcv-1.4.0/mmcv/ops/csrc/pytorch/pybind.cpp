...
void modulated_deform_conv_fast_forward(Tensor offset, Tensor input, Tensor output,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("modulated_deform_conv_forward", &modulated_deform_conv_forward,
        ...
        py::arg("with_bias"));
  m.def("modulated_deform_conv_deterministic_forward", &modulated_deform_conv_deterministic_forward,
        "modulated deform conv forward", py::arg("input"), py::arg("weight"),
        py::arg("bias"), py::arg("ones"), py::arg("offset"), py::arg("mask"),
        py::arg("output"), py::arg("columns"), py::arg("kernel_h"),
        py::arg("kernel_w"), py::arg("stride_h"), py::arg("stride_w"),
        py::arg("pad_h"), py::arg("pad_w"), py::arg("dilation_h"),
        py::arg("dilation_w"), py::arg("group"), py::arg("deformable_group"),
        py::arg("with_bias"), py::arg("im2col_step"));
  ...
  m.def("modulated_deformable_col2im_deterministic", &modulated_deformable_col2im_deterministic,
        "modulated_deformable_col2im_deterministic",
        py::arg("offset"), py::arg("add_index"), py::arg("add_value"),
        py::arg("height"),
        py::arg("width"), py::arg("height_out"),py::arg("width_out"),py::arg("kh_id"),py::arg("kw_id"),
        py::arg("kernel_h"),py::arg("kernel_w"),
        py::arg("stride_h"), py::arg("stride_w"), py::arg("pad_h"),
        py::arg("pad_w"), py::arg("dilation_h"), py::arg("dilation_w"),
        py::arg("g_id"));
    m.def("modulated_deform_conv_deterministic_backward", &modulated_deform_conv_deterministic_backward,
        "modulated deform conv deterministic backward", py::arg("input"),
        py::arg("offset"), py::arg("mask"),
        py::arg("columns"), py::arg("add_index"), py::arg("add_value"),
        py::arg("grad_offset"), py::arg("grad_mask"),
        py::arg("kernel_h"), py::arg("kernel_w"),
        py::arg("stride_h"), py::arg("stride_w"), py::arg("pad_h"),
        py::arg("pad_w"), py::arg("dilation_h"), py::arg("dilation_w"),
        py::arg("deformable_group"));
      m.def("grid_sample_deterministic_forward", &grid_sample_deterministic_forward,
        "grid_sample_deterministic_forward", py::arg("input"),
        py::arg("offset"), py::arg("output"),
        py::arg("offset_num"), py::arg("channel"), py::arg("height"),
        py::arg("width"));
      m.def("grid_sample_deterministic_input_backward", &grid_sample_deterministic_input_backward,
        "grid_sample_deterministic_input_backward", py::arg("grad_output"),
        py::arg("t2_indice"), py::arg("offset"),
        py::arg("batch_id"), py::arg("t2_i_i_s_id"), py::arg("t2_i_i_f_id"),
        py::arg("grad_input"), py::arg("group"),
        py::arg("offset_num"), py::arg("channel"),
        py::arg("height"), py::arg("width"));
      m.def("grid_sample_deterministic_offset_backward", &grid_sample_deterministic_offset_backward,
        "grid_sample_deterministic_offset_backward", py::arg("grad_output"),
        py::arg("input"), py::arg("offset"),
        py::arg("grad_offset"), py::arg("offset_num"), py::arg("channel"),
        py::arg("height"), py::arg("width"));
  m.def("modulated_deform_conv_fast_backward", &modulated_deform_conv_fast_backward,
        "modulated deform conv fast backward",py::arg("grad"), py::arg("offset"),
        py::arg("input"), py::arg("wh_mat"),
        py::arg("offset_temp"), py::arg("channels_per_group"), py::arg("height"),
        py::arg("width"));
  m.def("modulated_deform_conv_fast_forward", &modulated_deform_conv_fast_forward,
        "modulated deform conv fast forward", py::arg("offset"),
        py::arg("input"), py::arg("output"),
        py::arg("kernel_h"), py::arg("kernel_w"),  py::arg("batch_size"),
        py::arg("deform_groups"), py::arg("channels_per_group"),py::arg("height"),
        py::arg("width"));
  ...
  m.def("roi_align_backward", &roi_align_backward, "roi_align backward",
        ...
        py::arg("aligned_width"), py::arg("spatial_scale"),
        py::arg("sampling_ratio"), py::arg("pool_mode"), py::arg("aligned"));
  m.def("roi_align_deterministic_backward", &roi_align_deterministic_backward, "roi_align_deterministic backward",
        py::arg("grad_output"), py::arg("rois"), py::arg("argmax_y"),
        py::arg("argmax_x"), py::arg("index_add"), py::arg("add"), py::arg("aligned_height"),
        py::arg("aligned_width"), py::arg("spatial_scale"),
        py::arg("sampling_ratio"), py::arg("pool_mode"), py::arg("aligned"),  py::arg("batch_size"), py::arg("channels"), py::arg("height"), py::arg("width"),
        py::arg("sparse_index"));
