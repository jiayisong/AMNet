...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/_base_/datasets/chilun_detection.py', help='train config file path')
    parser.add_argument(
        '--skip-type',
        type=str,
        nargs='+',
    ...
    parser.add_argument(
        '--output-dir',
        default='/mnt/DataSets/齿轮检测数据集/trainval/ground_truth_resize/',
        type=str,
